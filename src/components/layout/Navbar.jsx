      ...
      <Container className="relative">
        <div className="flex justify-between">
          ...
          <div className="hidden md:flex md:items-center md:justify-between md:w-full relative">
            ...
            >
              ...
              {showButtons && (
                <button
                  className={cn(
                    "mr-2 flex-shrink-0 z-10 p-1 cursor-pointer transition-opacity duration-200",
                    canScrollLeft
                      ? "opacity-100"
              ...
              >
                ...
                >
                  <Link
                    href="/"
                    className="inline-flex items-center px-3 py-2 text-sm font-medium text-white whitespace-nowrap"
                  >
                    সর্বশেষ
                  </Link>
                  {categories?.map((item) => (
              ...
              {showButtons && (
                <button
                  className={cn(
                    "ml-2 flex-shrink-0 z-10 p-1 cursor-pointer transition-opacity duration-200",
                    canScrollRight
                      ? "opacity-100"
                      : "opacity-50 cursor-not-allowed"
                  )}
          ...
          <div className="flex items-center md:hidden">
            <button
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-500"
    ...
    <div className="relative flex-shrink-0">
      {hasSubmenu ? (
        <>
          ...
          <div className="inline-flex items-center px-3 py-2 text-sm font-medium text-white whitespace-nowrap">
