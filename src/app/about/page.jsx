...
const page = () => {
  return (
    <Container className="py-6">
      ...
      {/*  যোগাযোগ করুন */}
      <div>
        <h3 className="text-3xl font-bold text-center my-6">যোগাযোগ করুন</h3>
        <div className="grid grid-cols-12 gap-6">
          {/* details */}
          <div className="lg:col-start-2 col-span-5 bg-[#F9FAFB] rounded-2xl p-8">
            <div className="flex gap-4 pb-8">
              <div className="bg-[#E4E4E4] rounded-full w-fit h-fit p-3.5">
                <Mail size={20} />
              </div>
              <div className="flex flex-col">
                <h2 className="text-xl">ইমেইল ঠিকানা</h2>
            ...
            <div className="flex gap-4 pb-8">
              ...
              <div className="flex flex-col">
                <h2 className="text-xl">ফোন নম্বর</h2>
                <a className="text-md" href="">
                  +1 (555) 123-4567
                </a>
                <a className="text-md" href="">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col">
                <h2 className="text-xl">অফিসের ঠিকানা</h2>
                <a className="text-md" href="">
          ...
          {/* map */}
          <div className="col-span-5 relative rounded-2xl">
            <iframe
